            ...
            this.props.users.map(user =>
                <div className={style.usersWrapper} key={user.id}>
                    ...
                    <div className={style.userData}>
                        ...
                        {user.followed
                            ? <button className={style.followButton} onClick={() => { this.props.unfollow(user.id)}} >Unfollow</button>
                            : <button className={style.followButton} onClick={() => { this.props.follow(user.id)}} >Follow</button>
                        }
                    </div>
                </div>
            )
